...
Одна команда: формат, сборка, тесты, релизная сборка и шесть самопроверок,
...
Путь DXGI на машине замера не измерен (молчит). Рассинхрон звука на живой
десятиминутной записи не мерился: критерий «меньше 20 мс» доказан тестами на
модели часов, вживую — только на коротких записях.
